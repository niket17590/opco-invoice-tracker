...
export default function Clients() {
  ...
  function openEdit(c){ setEditId(c.id); setForm({ name:c.name, address:c.address, phone:c.phone, email:c.email, consulting_client:c.consulting_client, payment_terms_days:c.payment_terms_days, hourly_rate:c.hourly_rate }); setError(null); setShow(true) }
